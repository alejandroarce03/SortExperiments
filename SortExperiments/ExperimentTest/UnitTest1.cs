...
namespace ExperimentTest
{
    ...
    {
        private int[] arreglo10a1;
        private int[] arreglo10a2;
        private int[] arreglo10a3;
        ...
        public void TestMergeSort()
        {
            ...
            experiment.MergeSort(arreglo10a1);
            experiment.MergeSort(arreglo10a2);
            
            Assert.AreEqual<int[]>(respuesta1,arreglo10a1);
            Assert.AreEqual<int[]>(respuesta2, arreglo10a2);
            Assert.AreEqual<int[]>(copia3,arreglo10a3);
